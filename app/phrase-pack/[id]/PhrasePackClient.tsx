...
export default function PhrasePackClient({ packData }: { packData: PackData }) {
  ...
  const IconComponent = iconMap[packData.icon as keyof typeof iconMap] || Backpack
  ...
  const languages: string[] = [...new Set(packData.phrases.map((p) => p.language))]
